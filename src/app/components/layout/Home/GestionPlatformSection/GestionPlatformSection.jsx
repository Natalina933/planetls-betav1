...
const OFFERS = [
  {
    ...
    desc: (
      <>
        Trouvez des professionnels qualifiés, rapidement et en autonomie.
        <br />
        <b>Recommandé pour particuliers ou petites structures</b>
      </>
    ),
    price: "5%",
    priceLabel: (
  ...
  },
  {
    ...
    desc: (
      <>
        Optimisez votre expérience avec un accompagnement personnalisé.
        <br />
        <b>Recommandé pour structures en croissance</b>
      </>
    ),
    price: "9%",
    priceLabel: (
