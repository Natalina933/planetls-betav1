    ...
    <div className={styles.content}>
      ...
      <div className={styles.blocks}>
        ...
        <div className={styles.blockHomeowner}>
          ...
          <div variant="primary" className={styles.CTAButton}>Trouver une conciergerie</div>
        </div>
        ...
        <div className={styles.blockManager}>
          ...
          <div variant="primary" className={styles.CTAButton}>Développer mon réseau</div>
        </div>
        ...
        <div className={styles.blockPartner}>
          ...
          <div variant="primary" className={styles.CTAButton}>Proposer mon savoir-faire</div>
        </div>
      </div>
      ...
      <div className={styles.heroActions}>
        <div className={styles.buttonsRow}>
          <div variant="primary" className={styles.CTAButton}>Proposer un service</div>
          <div variant="secondary" className={styles.CTAButton}>Rechercher un prestataire</div>
        </div>
