...
export const sidebarConfig: Record<UserType, SidebarItem[]> = {
  owner: [
    ...
    { label: "Mon Reglement", path: "/dashboard/owner/reglement", icon: FiSettings },
    { label: "Mes stocks", path: "/dashboard/owner/stocks", icon: FiBox },
    { label: "Alertes", path: "/dashboard/owner/alertes", icon: FiBell },
    { label: "Parametres", path: "/dashboard/owner/settings", icon: FiSettings },
  ],
  ...
  concierge: [
    ...
    { label: "Historique Stripe", path: "/dashboard/concierge/billing", icon: FiFileText },
  ...
  providence: [
    ...
    { label: "Mes Taches", path: "/dashboard/providence/taches", icon: FiClipboard },
    ...
    { label: "Parametres", path: "/dashboard/providence/settings", icon: FiSettings },
  ],
  ...
  artisan: [
    ...
    { label: "Parametres", path: "/dashboard/artisan/settings", icon: FiSettings },
  ],
};
