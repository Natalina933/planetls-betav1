...
const features = [
  "Tableau de bord avance pour piloter logements, missions et revenus",
  "Priorisation des leads proprietaires et outils de conversion",
...
const summary = [
  ...
  "Pense pour les profils qui veulent aller plus loin",
  "Une offre avancee, sans empecher de commencer en standard",
];

export default function ConciergeProSubscriptionPageClient() {
    ...
    <div className={styles.page}>
      <div className={styles.shell}>
        <section className={styles.hero}>
          ...
          <h1 className={styles.title}>Passez a des outils plus avances quand vous en avez besoin.</h1>
          <p className={styles.subtitle}>
            Cette page pose la base du module d&apos;abonnement Stripe pour les concierges.
            L&apos;idee est simple : vous pouvez commencer avec une activite standard, puis passer en
            PRO lorsque vous avez besoin de davantage de pilotage et d&apos;outils premium.
          </p>
            ...
            <div className={styles.statusCard}>
              ...
              <span>
                {isPro
                  ...
                  : "Commencez en standard, puis passez en PRO lorsque votre activite a besoin d'outils plus avances."}
              </span>
              {subscriptionRef ? (
