export const designSections = [
  { href: "/design-system", title: "Accueil", description: "Choisir ce que vous souhaitez examiner." },
...
export const designSpaces = [
  { id: "admin", title: "Administrateur", href: "/design-system/admin-dashboard" },
  { id: "owner", title: "Propriétaire", href: "/design-system/owner-dashboard" },
  { id: "concierge", title: "Concierge", href: "/design-system/concierge-dashboard" },
  { id: "provider", title: "Artisan / prestataire", href: "/design-system/provider-dashboard" },
] as const;
