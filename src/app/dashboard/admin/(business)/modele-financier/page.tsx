              ...
              <Card tone="outlined" className={styles.card}>
                <CardHeader className={styles.cardHeader}>
                  ...
                  <div>
                    ...
                    <strong>{ACTIVE_PRICING_DECISIONS[0]?.nextReview ?? "A planifier"}</strong>
                  </div>
                </CardHeader>
                <CardBody className={styles.cardBody}>
                  <p className={styles.metricReason}>
                    {ACTIVE_PRICING_DECISIONS[0]?.decision ?? "Aucune decision ouverte detectee"}
                  </p>
                  <p>
              ...
              {TARGET_SIMULATION_TIERS.map((tier) => (
                <Card key={tier.id} tone="soft" className={styles.card}>
                  ...
                  <CardBody className={styles.cardBody}>
                    ...
                    <p>{tier.notes ?? "Tier de simulation sans note complementaire."}</p>
                  </CardBody>
                </Card>
              ))}
            </div>
