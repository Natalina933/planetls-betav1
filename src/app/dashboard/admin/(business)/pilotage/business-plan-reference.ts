...
const PILOTAGE_SOURCE: BusinessPlanSource = {
  ...
  reference: "src/app/dashboard/admin/(business)/pilotage/businessPlanData.ts",
};

const ECONOMIC_MODEL_SOURCE: BusinessPlanSource = {
  type: "economic_model",
  label: "Modele economique PlanetLS",
  reference: "src/app/dashboard/admin/(business)/pilotage/economic-model/data.ts",
};

const VALIDATION_SOURCE: BusinessPlanSource = {
  type: "market_validation",
  label: "Validation marche PlanetLS",
  reference: "src/app/dashboard/admin/(business)/pilotage/market-validation/validationData.ts",
};

const RISK_SOURCE: BusinessPlanSource = {
  type: "risk_register",
  label: "Registre de risques PlanetLS",
  reference: "src/app/dashboard/admin/(business)/pilotage/risk-register/riskData.ts",
};
