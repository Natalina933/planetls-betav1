...
const PRIORITY_TABLE_ROWS: PriorityTableRow[] = [
  ...
  },
  {
    ...
    difficulty: "Élevée",
    impact: "⭐⭐⭐⭐",
    zones: "src/app/dashboard/admin/(business)/pilotage/, src/app/api/admin/",
  },
  {
    id: "P2-001",
    level: "P2",
  ...
  },
  {
    ...
    difficulty: "Moyenne",
    impact: "⭐⭐⭐",
    zones: "src/app/dashboard/admin/(operations)/controle/",
  },
  {
    id: "P2-009",
    level: "P2",
  ...
  },
  {
    ...
    difficulty: "Moyenne",
    impact: "⭐⭐⭐",
    zones: "src/app/dashboard/admin/(product-tech)/developpement/personas/, src/components/development/",
  },
  {
    id: "P2-015",
    level: "P2",
  ...
  },
  {
    id: "P2-017",
    level: "P2",
    title: "Finaliser la lisibilité desktop et le référentiel des cartes Personas",
    category: "UX/UI",
    difficulty: "Moyenne",
    impact: "⭐⭐⭐",
    zones: "src/app/dashboard/admin/(business)/personas/, src/app/dashboard/admin/(business)/pilotage/personas/",
  },
  {
    id: "P2-018",
    level: "P2",
    title: "Normaliser entièrement l'encodage français du Master Plan",
    category: "Documentation",
    difficulty: "Moyenne",
    impact: "⭐⭐⭐",
    zones: "docs/master-plan-planetls.md, scripts/check-encoding.mjs",
  },
  {
    id: "P2-019",
    level: "P2",
    title: "Valider le modèle d'ouverture des cartes Personas après le lot desktop",
    category: "UX/UI",
    difficulty: "Moyenne",
    impact: "⭐⭐⭐",
    zones: "src/app/dashboard/admin/(business)/personas/, src/app/dashboard/admin/(business)/pilotage/personas/",
  },
  {
    id: "P2-020",
    level: "P2",
    title: "Optimiser les tournées quotidiennes des concierges et équipes",
    category: "Planning",
    difficulty: "Élevée",
    impact: "⭐⭐⭐⭐",
    zones: "src/app/dashboard/concierge/planning/, src/app/api/concierge/optimized-routes/, src/app/api/concierge/team/",
  },
  {
    id: "P2-021",
    level: "P2",
    title: "Structurer un compte rendu vocal IA pour les check-in et check-out",
    category: "IA",
    difficulty: "Élevée",
    impact: "⭐⭐⭐⭐",
    zones: "src/app/dashboard/concierge/sejours/, src/app/dashboard/concierge/missions/, src/app/api/reservations/, src/app/api/workflow-events/",
  },
  {
    id: "P2-022",
    level: "P2",
    title: "Automatiser le flux demande, devis et transformation en mission",
    category: "Automatisation",
    difficulty: "Élevée",
    impact: "⭐⭐⭐⭐",
    zones: "src/app/api/service-requests/, src/app/api/quotes/, src/app/api/missions/, src/app/dashboard/owner/demandes/, src/app/dashboard/concierge/demandes/",
  },
  {
    id: "P2-023",
    level: "P2",
    title: "Déclencher des relances automatiques sur devis, missions et paiements",
    category: "Automatisation",
    difficulty: "Moyenne",
    impact: "⭐⭐⭐⭐",
    zones: "src/app/api/quotes/, src/app/api/missions/, src/app/api/billing/, src/server/notifications/, src/app/dashboard/owner/, src/app/dashboard/concierge/",
  },
  {
    id: "P2-024",
    level: "P2",
    title: "Préciser les règles métier des automatismes avant développement",
    category: "Produit",
    difficulty: "Moyenne",
    impact: "⭐⭐⭐⭐",
    zones: "docs/master-plan-planetls.md, src/app/api/quotes/, src/app/api/missions/, src/app/api/billing/, src/server/notifications/",
  },
  {
    id: "P2-025",
    level: "P2",
    title: "Formaliser la feuille de route d'intégration IA et automatisation par phases",
    category: "Pilotage",
    difficulty: "Moyenne",
    impact: "⭐⭐⭐⭐",
    zones: "docs/master-plan-planetls.md, docs/ai/, src/app/dashboard/admin/(product-tech)/developpement/",
  },
  {
    id: "P2-026",
    level: "P2",
    title: "Consolider le cadrage conformité IA et les sources officielles de référence",
    category: "Conformité",
    difficulty: "Faible",
    impact: "⭐⭐⭐",
    zones: "docs/master-plan-planetls.md, docs/ai/, futurs livrables PDF",
  },
  {
    id: "P2-027",
    level: "P2",
    title: "Documenter le nouveau cadrage tarifaire admin 0 / 19,90 / 49 / 149",
    category: "Pilotage",
    difficulty: "Faible",
    impact: "⭐⭐⭐",
    zones: "docs/master-plan-planetls.md, src/app/dashboard/admin/(business)/modele-financier/, src/app/dashboard/admin/(business)/pilotage/economic-model/",
  },
  {
    id: "P2-028",
    level: "P2",
    title: "Clarifier la coexistence entre l'offre Stripe réelle à 29 EUR et la gamme de travail admin",
    category: "Pricing",
    difficulty: "Moyenne",
    impact: "⭐⭐⭐⭐",
    zones: "src/app/dashboard/admin/(business)/modele-financier/, src/app/dashboard/admin/(business)/pilotage/economic-model/, docs/master-plan-planetls.md",
  },
  {
    id: "P2-029",
    level: "P2",
    title: "Nettoyer les derniers libellés historiques de pricing encore divergents",
    category: "Documentation",
    difficulty: "Moyenne",
    impact: "⭐⭐⭐",
    zones: "docs/master-plan-planetls.md, src/app/dashboard/admin/(business)/pilotage/, src/app/dashboard/admin/(business)/modele-financier/",
  },
  {
    id: "P2-030",
    level: "P2",
    ...
    difficulty: "Moyenne",
    impact: "⭐⭐⭐⭐",
    zones: "src/app/dashboard/admin/(business)/pilotage/, src/app/dashboard/admin/(product-tech)/developpement/, docs/master-plan-planetls.md",
  },
  {
    id: "P2-031",
    level: "P2",
  ...
  },
  {
    ...
    difficulty: "Moyenne",
    impact: "⭐⭐⭐⭐",
    zones: "src/app/dashboard/admin/(product-tech)/developpement/, src/app/dashboard/admin/(business)/pilotage/, docs/master-plan-planetls.md",
  },
  {
    id: "P2-035",
    level: "P2",
    ...
    difficulty: "Moyenne",
    impact: "⭐⭐⭐⭐",
    zones: "docs/master-plan-planetls.md, futurs questionnaires et guides d'entretien, src/app/dashboard/admin/(business)/pilotage/",
  },
  {
    id: "P2-036",
    level: "P2",
  ...
  },
  {
    ...
    difficulty: "Moyenne",
    impact: "⭐⭐⭐⭐",
    zones: "docs/master-plan-planetls.md, futurs ateliers terrain, src/app/dashboard/admin/(product-tech)/developpement/",
  },
  {
    id: "P3-001",
    level: "P3",
  ...
  },
  {
    ...
    difficulty: "Faible",
    impact: "⭐⭐",
    zones: "src/app/dashboard/admin/(product-tech)/developpement/, src/design-system/",
  },
  {
    id: "P3-014",
    level: "P3",
...
function updateSignals(update: MasterPlanUpdateEntry) {
  const signals: string[] = [];
  if (update.isNew) signals.push("Nouveau lot");
  if (update.statusChanged) signals.push("Statut modifié");
  if (update.priorityChanged) signals.push("Priorité modifiée");

  const category = functionalStatusCategory(update.status);
  if (category === "done") signals.push("Terminé");
  if (category === "active") signals.push("En cours");
  if (category === "blocked") signals.push("Bloqué");
  if (category === "todo") signals.push("À planifier");
  if (update.ideas.length > 0) signals.push("Idée ajoutée");
  if (update.nextActions.length > 0) signals.push("Tâche suivante");
  return signals;
}

function updateSummary(update: MasterPlanUpdateEntry) {
  return update.productChanges[0]
    ?? update.decisions[0]
    ?? update.contradictions[0]
    ?? "Mise à jour de pilotage détectée dans le Master Plan.";
}

function statusVisual(status: string) {
  const category = functionalStatusCategory(status);
  if (category === "done") {
    return { label: status || "Terminé", className: styles.statusDone, icon: CheckCircle2 };
  }
  if (category === "active") {
    return { label: status || "En cours", className: styles.statusActive, icon: Clock3 };
  }
  if (category === "blocked") {
    return { label: status || "Bloqué", className: styles.statusBlocked, icon: AlertTriangle };
  }
  if (category === "todo") {
    return { label: status || "À faire", className: styles.statusTodo, icon: CircleDashed };
  }

  const normalized = normalizeComparable(status);
  if (normalized.includes("abandonne")) {
    return { label: status || "Abandonné", className: styles.statusAbandoned, icon: XCircle };
  }
  if (normalized.includes("reporte")) {
    return { label: status || "Reporté", className: styles.statusDeferred, icon: PauseCircle };
  }

  return { label: status || "Statut non renseigné", className: styles.statusNeutral, icon: CircleDashed };
}
...
export function MasterPlanViewer({ plan, journal, missionControl, roadmap, technicalMemory, defaultAuthor, projectVersion }: MasterPlanViewerProps) {
  ...
  const recentUpdateRows = useMemo(() => [...plan.updates]
    ...
    .map((update) => ({
      ...
      nextAction: update.nextActions[0] ?? "Aucune prochaine étape renseignée.",
      scope: update.scope.length ? update.scope.slice(0, 3).join(", ") : "Périmètre non renseigné",
      signals: updateSignals(update),
      ideas: update.ideas,
      tasks: update.nextActions,
    } satisfies RecentUpdateRow)), [plan.updates]);
  const recentUpdateDoneCount = useMemo(
    () => recentUpdateRows.filter((row) => functionalStatusCategory(row.status) === "done").length,
    [recentUpdateRows],
  );
  const recentUpdateActiveCount = useMemo(
    () => recentUpdateRows.filter((row) => functionalStatusCategory(row.status) === "active").length,
    [recentUpdateRows],
  );
  const recentUpdateIdeaCount = useMemo(
    () => recentUpdateRows.filter((row) => row.signals.includes("Idée ajoutée")).length,
    [recentUpdateRows],
  );
  const recentUpdateTaskCount = useMemo(
    () => recentUpdateRows.filter((row) => row.signals.includes("Tâche suivante")).length,
    [recentUpdateRows],
  );
  ...
  const executionSummary = recentUpdateRows.length
    ? `${recentUpdateRows.length} mise(s) à jour de pilotage détectée(s) automatiquement depuis le Master Plan`
    : `${plan.planning.length} priorité(s) encore actives dans le registre officiel`;
    ...
    <div className={styles.page}>
      <section className={styles.compactShell}>
        ...
        <Card>
          <CardHeader className={styles.panelHeader}>
            <div>
              <strong>Pilotage des priorités</strong>
      ...
      {panelOpen.execution ? <div id="execution-panel" className={styles.foldableContent}>
        ...
        <div className={styles.auditGrid}>
          ...
          <article className={styles.auditCard}>
            ...
            <p>{executionRowsByPriority.p1.length} lot(s) prioritaires suivent encore un statut ou une action de stabilisation.</p>
          </article>
          <article className={styles.auditCard}>
        ...
        <div className={styles.executionUpdatesGrid}>
          <article className={styles.executionStatusCard}>
            <span>Mises à jour</span>
            <strong>{recentUpdateRows.length}</strong>
            <p>Lots de pilotage relus automatiquement depuis les dernières entrées ciblées du Master Plan.</p>
          </article>
          <article className={styles.executionStatusCard}>
            <span>Terminées</span>
            <strong>{recentUpdateDoneCount}</strong>
            <p>Pour repérer rapidement ce qui vient d’être soldé et ne doit plus rester dans le flou.</p>
          </article>
          <article className={styles.executionStatusCard}>
            <span>En cours</span>
            <strong>{recentUpdateActiveCount}</strong>
            <p>Les lots encore actifs ou partiels visibles directement sans relire tout le document.</p>
          </article>
          <article className={styles.executionStatusCard}>
            <span>Idées / tâches</span>
            <strong>{recentUpdateIdeaCount + recentUpdateTaskCount}</strong>
            <p>{recentUpdateIdeaCount} idée(s) ajoutée(s) et {recentUpdateTaskCount} prochaine(s) tâche(s) remontée(s).</p>
          </article>
        </div>
            ...
            <thead>
              ...
              {recentUpdateRows.map((row) => (
                <tr key={row.id}>
                  ...
                  <td>
                    <div className={styles.updateDetailList}>
                      {row.ideas.slice(0, 2).map((idea) => <span key={`${row.id}-idea-${idea}`}>Idée : {idea}</span>)}
                      {row.tasks.slice(0, 2).map((task) => <span key={`${row.id}-task-${task}`}>Tâche : {task}</span>)}
                      {!row.ideas.length && !row.tasks.length ? <span>Aucune idée ou tâche explicite détectée.</span> : null}
                    </div>
                  </td>
                  <td>{row.scope}</td>
                  <td>
                    <div className={styles.updateSignalList}>
                      {row.signals.map((signal) => <span key={`${row.id}-${signal}`} className={styles.updateSignal}>{signal}</span>)}
                    </div>
                  </td>
                </tr>
              ))}
...
function StatusBadge({ status }: { status: string }) {
  ...
  return (
    <span className={[styles.statusBadge, visual.className].join(" ")}>
