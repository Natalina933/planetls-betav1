...
| KPI activation/funnel | ✅ Terminé | P0 Critique | Court terme | Data + Produit | Définitions J+7, cohortes, séries et zones validées sur l’API connectée ; seuils par rôle, alerte faible échantillon, baisse de cohorte et actions admin visibles |
...
| Administration | Centre de santé opérationnelle | Admin | ✅ Terminé | P0 Critique | 2026-07-19 | État global sur 12 sources, sources non vérifiables explicites et cycle persistant : prise en charge, transmission au responsable et clôture avec compte rendu, sans masquer l’anomalie ; contrat 10/10, E2E connecté 1/1, suite 199/199 et build 168 pages | Corriger séparément les dérives connectées missions.title et onboarding_events.profile_id, puis surveiller les suivis transmis |
...
- **Vue de développement du Master Plan** — `✅ Terminé`, `P1 Prioritaire` au 2026-07-19. Preuve : route admin sécurisée `/dashboard/admin/developpement`, lecture serveur du fichier, synthèse, recherche, filtres statut/priorité, sommaire et test du parseur. Prochaine action : valider la lisibilité mobile et enrichir seulement selon l'usage réel.
  ...
  - Planning opérationnel : la vue extrait automatiquement les chantiers non terminés du registre de maintenance, les ordonne en horizons `Maintenant`, `Ensuite`, `Après stabilisation`, `Plus tard`, et expose prochaine action, preuve et profils concernés sans dupliquer la roadmap. Preuves : parseur `3/3 PASS`, 193/193 tests, lint ciblé et build 168 pages.
